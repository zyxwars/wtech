<x-layout>
    ...
    <main class="flex min-h-screen justify-center">
        <div
            class="flex w-full max-w-[1600px] flex-col items-center px-4 lg:px-20">
            <!-- Banner -->
            <a href="{{$banner['content_url']}}" class="my-6 w-full flex-none">
                <div class="flex flex-col relative w-full items-center">
                    ...
                    <button
                        class="btn btn-primary absolute bottom-2 left-2 sm:bottom-6 sm:left-6"
                        href="{{$banner['content_url']}}">
                        More
                    </button>

                    <img
                        class="h-52 w-full object-cover object-center shadow-sm sm:h-64 lg:h-80"
            ...
            <nav class="category-grid mb-10">
                ...
                <a
                    ...
                    <img
                        class="h-12 w-12 flex-none rounded-full object-cover object-center shadow-sm md:h-16 md:w-16"
                        src="/placeholder.png" />
            ...
            <section class="flex w-full flex-col gap-6">
                @foreach ($featuredProducts as $featuredRow)
